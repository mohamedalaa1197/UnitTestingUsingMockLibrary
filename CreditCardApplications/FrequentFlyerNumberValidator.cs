...
namespace CreditCardApplications
{
    ...
    {
        public ILicenceService LicenceService { get => throw new NotImplementedException(); }
        public ValidatorType ValidatorType { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }

        public event EventHandler ValidatorLookupPerformance;

        //public string LicenceKey => throw new NotImplementedException("For demo purpose");
